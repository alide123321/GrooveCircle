...
router.post('/', async (req, res) => {
	...
	// Convert chatroomid to 24 character hex string if it's not already
	...
	try {
		...
		await chatroomCollection.updateOne({ _id: new ObjectId(chatroomid) }, { $push: { messages: newMessage } });
